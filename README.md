...
The Yeast dataset itself can be downloaded online from the MassIVE proteomics repository: [here](ftp://massive.ucsd.edu/MSV000082805). The repository contains both raw as peak picked data, so it is up to you whether you want to skip the raw file processing with MSConvertGUI, or not. 
